    ...
    child: Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ClipRRect(
          ...
          child: Image.network(restaurant.imageUrl, height: 110, width: double.infinity, fit: BoxFit.cover,
              errorBuilder: (_, __, ___) => Container(height: 110, color: Theme.of(context).scaffoldBackgroundColor, child: const Icon(Icons.restaurant, size: 40, color: AppTheme.grey))),
        ),
        Padding(
        ...
        Stack(children: [
          ClipRRect(
            ...
            child: ColorFiltered(
              ...
              child: Image.network(restaurant.imageUrl, height: 155, width: double.infinity, fit: BoxFit.cover,
                  errorBuilder: (_, __, ___) => Container(height: 155, color: Theme.of(context).scaffoldBackgroundColor, child: const Icon(Icons.restaurant, size: 50, color: AppTheme.grey))),
            ),
          ),
          if (!restaurant.isOpen)
