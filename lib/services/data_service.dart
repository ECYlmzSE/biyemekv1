...
class DataService {
    ...
    'doner': [
      [
        MenuCategory(id:'doa1', name:'🌯 Dürüm & Döner', items:[
          _mi('doa1','Et Dürüm',450.00,'Dana döner, lavaş, sebze, sos','assets/food/doner.jpg',pop:true),
          _mi('doa2','Tavuk Dürüm',250.00,'Tavuk döner, lavaş, yoğurt sos','assets/food/doner.jpg'),
          _mi('doa3','Karışık Dürüm',480.00,'Et+tavuk, közlenmiş sebze','assets/food/doner.jpg',pop:true),
          _mi('doa4','İskender Dürüm',520.00,'İskender sos, tereyağı, yoğurt','assets/food/doner.jpg',pop:true),
        ...
        MenuCategory(id:'doa2', name:'🥗 Mezeler & Çorbalar', items:[
          _mi('dos1','Mercimek Çorbası',90.00,'Ev yapımı, sıcak','https://images.unsplash.com/photo-1547592180-85f173990554?w=400',veg:true),
      ...
      [
        ...
        MenuCategory(id:'dob2', name:'🍚 Pilav & Ekstra', items:[
          _mi('dob7','Bulgur Pilavı',90.00,'Nohutlu bulgur pilavı','https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400',veg:true),
          _mi('dob8','Pirinç Pilav',80.00,'Tereyağlı pirinç','https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400',veg:true),
    ...
    'sokak': [
      ...
      [
        MenuCategory(id:'skb1', name:'🥙 Simit & Açık Büfe', items:[
          ...
          _mi('skb5','Çiğ Köfte Dürüm',120.00,'Acılı/acısız, nar ekşisi','assets/food/cig_kofte.jpg',veg:true),
        ]),
        _drinksEx('skdb'),
      ],
    ],
    ...
    'kahve': [
      [
        MenuCategory(id:'kfa1', name:'☕ Sıcak İçecekler', items:[
          ...
          _mi('kfa6','Türk Kahvesi',160.00,'Geleneksel, lokum ile','https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400',veg:true),
  ...
  static MenuCategory _drinksEx(String pfx) => MenuCategory(
    id:'${pfx}_d', name:'🥤 İçecekler', items:[
      MenuItem(id:'${pfx}d1',name:'Ayran',description:'Soğuk ayran 300ml',price:55.00,imageUrl:'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400'),
      MenuItem(id:'${pfx}d2',name:'Cola 330ml',description:'Gazlı içecek',price:65.00,imageUrl:'https://images.unsplash.com/photo-1561758033-d89a9ad46330?w=400'),
      MenuItem(id:'${pfx}d3',name:'Sprite 330ml',description:'Limonlu gazlı',price:65.00,imageUrl:'https://images.unsplash.com/photo-1561758033-d89a9ad46330?w=400'),
      MenuItem(id:'${pfx}d4',name:'Su 500ml',description:'Kaynak suyu',price:50.00,imageUrl:'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400'),
      MenuItem(id:'${pfx}d5',name:'Taze Portakal Suyu',description:'100% taze sıkılmış',price:90.00,imageUrl:'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=400'),
      MenuItem(id:'${pfx}d6',name:'Limonata',description:'Taze limon, nane, soda',price:80.00,imageUrl:'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=400'),
      MenuItem(id:'${pfx}d7',name:'Ice Tea',description:'Şeftali veya limon',price:70.00,imageUrl:'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400'),
    ],
  );
  ...
  static final Map<String, List<MenuCategory>> _menus = {
    ...
    'cigkofte': [
      MenuCategory(id:'cgk1', name:'🌿 Çiğ Köfte', items:[
        _mi('cgk1','Dürüm Acılı',120.00,'Çiğ köfte, nar ekşisi, limon, lavaş','assets/food/cig_kofte.jpg',veg:true,pop:true,spicy:true),
        _mi('cgk2','Dürüm Acısız',110.00,'Çiğ köfte, limon, lavaş','assets/food/cig_kofte.jpg',veg:true),
        ...
        _mi('cgk5','İkili Dürüm',220.00,'2 adet dürüm, acı/acısız seçimli','assets/food/cig_kofte.jpg',veg:true,pop:true),
    ...
    'tantuni': [
      MenuCategory(id:'tnt1', name:'🌮 Tantuni', items:[
        _mi('tnt1','Tantuni Dürüm',250.00,'Dana et, soğan, domates, lavaş','assets/food/tantuni.jpg',pop:true,spicy:true),
        ...
        _mi('tnt4','İkili Dürüm Menü',340.00,'2 dürüm + şalgam + turşu','assets/food/tantuni.jpg',pop:true),
    ...
    'lahmacun': [
      MenuCategory(id:'lhm1', name:'🫓 Lahmacun', items:[
        ...
        _mi('lhm3','Lahmacun + Ayran',230.00,'3 adet lahmacun + soğuk ayran','https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400',pop:true),
        _mi('lhm4','Dürüm Lahmacun',160.00,'Dürüm şeklinde, limon, maydanoz','https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=400'),
    ...
    'starbucks': [
      MenuCategory(id:'sbx1', name:'☕ Espresso İçecekleri', items:[
        ...
        _mi('sbx6','Türk Kahvesi',170.00,'Geleneksel Türk kahvesi','https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400',veg:true),
      ]),
    ...
    'komagene': [
      ...
      MenuCategory(id:'kom2', name:'🌯 Dürümler', items:[
        _mi('komd1','Favori Çiğ Köfte Dürüm',109.90,'Dürüm, yeşillik, sos','assets/food/cig_kofte.jpg',veg:true,pop:true),
        _mi('komd2','Mega Çiğ Köfte Dürüm',119.90,'Büyük boy dürüm','assets/food/cig_kofte.jpg',veg:true),
        _mi('komd3','Doritos\'lu Dürüm',125.90,'Doritos ile ekstra çıtırlık','assets/food/cig_kofte.jpg',veg:true,pop:true),
        _mi('komd4','Double Dürüm',140.90,'Çift dürüm','assets/food/cig_kofte.jpg',veg:true),
      ]),
    ...
    'tavuk': [
      MenuCategory(id:'tm1', name:'🍗 Tavuk', items:[
        ...
        _mi('tb2','Tavuk Dürüm',260.00,'Izgara tavuk, sebze, lavaş','assets/food/tavuk_dunyasi.jpg',opts:[MenuOption(id:'to1',name:'Acı Sos'),MenuOption(id:'to2',name:'Soğan',isRemovable:true)]),
    ...
    'doner': [
      MenuCategory(id:'dm1', name:'🌯 Döner', items:[
        _mi('db1','Et Dürüm',450.00,'Dana döner, lavaş, sebze','assets/food/doner.jpg',pop:true,opts:[MenuOption(id:'do1',name:'Acı Sos'),MenuOption(id:'do2',name:'Ekstra Et',price:50),MenuOption(id:'do3',name:'Soğan',isRemovable:true)]),
        _mi('db2','Tavuk Dürüm',250.00,'Izgara tavuk, sebze','assets/food/doner.jpg'),
    ...
    'deniz': [
      MenuCategory(id:'denim1', name:'🐟 Deniz Ürünleri', items:[
        ...
        _mi('denb4','Meze Tabağı',360.00,'Karışık deniz mezeleri','assets/food/deniz_urunleri.jpg'),
      ]),
      _drinks('dend'),
    ],
    'vegan': [
      MenuCategory(id:'vm1', name:'🥗 Ana Yemekler', items:[
        ...
        _mi('vb2','Falafel Dürüm',240.00,'Falafel, humus, turşu, lavaş','https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400',veg:true,pop:true),
        ...
        _mi('vb7','Mercimek Çorbası',200.00,'Mercimek çorbası, ekmek','https://images.unsplash.com/photo-1547592180-85f173990554?w=400',veg:true),
      ]),
    ...
    'kahve': [
      MenuCategory(id:'kfm1', name:'☕ Kahveler', items:[
        ...
        _mi('kfb2','Türk Kahvesi',160.00,'Geleneksel Türk kahvesi','https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400',veg:true),
        _mi('kfb3','Soğuk Kahve',210.00,'Cold brew / frappuccino','https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=400',veg:true),
    ...
    'pastane': [
      MenuCategory(id:'pam1', name:'🥐 Börekler & Hamur İşleri', items:[
        ...
        _mi('pab4','Su Böreği (Dilim)',89.90,'El açması peynirli su böreği','assets/food/pastane_firin.jpg',veg:true,pop:true),
    ...
    'ev': [
      MenuCategory(id:'evm1', name:'🍲 Günlük Yemekler', items:[
        ...
        _mi('evb4','Kuru Fasulye + Pilav',210.00,'Geleneksel kuru fasulye, pilav','assets/food/ev_yemekleri.jpg',veg:true,pop:true),
        ...
        _mi('evb8','Mercimek Çorbası',200.00,'Kırmızı mercimek çorbası','assets/food/ev_yemekleri.jpg',veg:true),
      ]),
      _drinks('evd'),
    ],
    'dunya': [
    ...
    'aspava': [
      MenuCategory(id:'asp1', name:'🥩 Döner', items:[
        ...
        _mi('asp_d2','Dürüm Et Döner',680,'Lavaşta et döner dürüm','assets/food/doner.jpg'),
        _mi('asp_d3','SSK Dürüm Döner',700,'Özel SSK dürüm','assets/food/doner.jpg'),
        _mi('asp_d4','İskender Kebap',730,'Döner, yoğurt, tereyağı, domates sosu, pide','assets/food/doner.jpg',pop:true),
        _mi('asp_d5','Pilav Üstü Döner',720,'Pilav + döner','assets/food/doner.jpg'),
    ...
    'bulentborekci': [
      MenuCategory(id:'bb1', name:'🥐 Börekler', items:[
        _mi('bb_b1','Su Böreği',180,'El açması, peynirli veya kıymalı','assets/food/pastane_firin.jpg',pop:true),
    ...
    'tatli': [
      MenuCategory(id:'tat1', name:'🍮 Tatlılar', items:[
        _mi('tat_b1','Baklava (6 Dilim)',280.00,'Antep fıstıklı ev baklavası','https://images.unsplash.com/photo-1519676867240-f03562e64548?w=400',veg:true,pop:true),
        _mi('tat_b2','Fıstıklı Baklava (4 Dilim)',240.00,'Özel fıstıklı baklava','https://images.unsplash.com/photo-1519676867240-f03562e64548?w=400',veg:true),
        ...
        _mi('tat_s1','Sütlaç',160.00,'Fırın sütlaç, tarçın','https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400',veg:true,pop:true),
        ...
        _mi('tat_m1','Muhallebi',150.00,'Gül sulu muhallebi','https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400',veg:true),
      ]),
      ...
      MenuCategory(id:'tat3', name:'🎂 Kek & Pasta', items:[
        ...
        _mi('tat_c3','Çikolatalı Kek',190.00,'Islak çikolatalı kek, ganaj','https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400',veg:true),
  ...
  static MenuCategory _drinks(String pfx) => MenuCategory(
    id:'${pfx}_d', name:'🥤 İçecekler', items:[
      MenuItem(id:'${pfx}d1', name:'Ayran', description:'Soğuk ayran 300ml', price:55.00, imageUrl:'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400'),
      MenuItem(id:'${pfx}d2', name:'Cola', description:'330ml', price:65.00, imageUrl:'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400'),
      MenuItem(id:'${pfx}d3', name:'Su', description:'500ml', price:50.00, imageUrl:'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400'),
      MenuItem(id:'${pfx}d4', name:'Meyve Suyu', description:'Taze sıkılmış portakal', price:80.00, imageUrl:'https://images.unsplash.com/photo-1497935586351-b67a49e012bf?w=400'),
    ],
  );
