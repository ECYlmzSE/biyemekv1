  ...
  SliverAppBar _buildAppBar(BuildContext context, Restaurant r, AuthProvider auth) {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        background: AppImage(url: r.imageUrl, fit: BoxFit.cover,
          errorWidget: Container(color: Theme.of(context).scaffoldBackgroundColor,
      ...
      child: Row(children: [
        ...
        Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ClipRRect(
            ...
            child: AppImage(url: item.imageUrl, width: 100, height: 85, fit: BoxFit.cover,
              errorWidget: Container(width: 100, height: 85, color: Theme.of(context).scaffoldBackgroundColor,
